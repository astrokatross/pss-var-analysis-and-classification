...
def curve(freq, freq_peak, peakfreq, alphathick, alphathin): # Model taken from Tschager et al. 2003. General fit not based on any physics. ##THIS IS EQN 3 IN JOES PAPER 
